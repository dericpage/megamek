...
public abstract class AbstractOptions implements IOptions, Serializable {
    ...
    public int count(final String groupKey) {
        ...
        for (final Enumeration<IOptionGroup> groupEnumeration = getGroups(); groupEnumeration
                .hasMoreElements(); ) {
            final IOptionGroup group = groupEnumeration.nextElement();
            if ((null != groupKey) && !group.getKey().equalsIgnoreCase(groupKey)) {
                continue;
            }
            for (final Enumeration<IOption> optionEnumeration = group.getOptions(); optionEnumeration
                    .hasMoreElements(); ) {
                final IOption option = optionEnumeration.nextElement();
    ...
    public String getOptionListString(String separator,
        ...
        for (final Enumeration<IOptionGroup> groupEnumeration = getGroups(); groupEnumeration.hasMoreElements(); ) {
            final IOptionGroup group = groupEnumeration.nextElement();
            ...
            for (final Enumeration<IOption> groupOptions = group.getOptions(); groupOptions
                    .hasMoreElements();) {
                final IOption option = groupOptions.nextElement();
                if (null != option && option.booleanValue()) {
    ...
    public float floatOption(final String name) {
    ...
    protected void addOption(final IBasicOptionGroup group,
                             final String name,
